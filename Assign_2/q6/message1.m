...
X = audioread('audio/message1.wav');
p  = audioinfo('audio/message1.wav');
Fs = p.SampleRate;
L = p.TotalSamples;
...
P2(domain_1) = P1(domain_2);
P2(domain_2) = P1(domain_1);
P2(domain_3) = P1(domain_3);
P2(domain_4) = P1(domain_4);
P2(domain_5) = P1(domain_5);
P2(domain_6) = P1(domain_6);
P2(domain_7) = P1(domain_8);
P2(domain_8) = P1(domain_7);
...
% filename = 'audio/decrypted_message1.wav';
